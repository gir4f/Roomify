            ...
            <div class="w-full px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Tambahkan fasilitas ruangan baru ke dalam sistem.</p>
                    </div>
                    <Link 
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input 
                                        ...
                                        placeholder="Contoh: Lab Komputer 1, Auditorium A"
                                        required
                                    />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        v-model="form.gedung"
                                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm text-sm"
                                        placeholder="Contoh: Gedung A, Fakultas Teknik"
                                    />
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm text-sm"
                                        placeholder="Contoh: AC, Proyektor, Whiteboard, Sound System"
                                    />
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        rows="3"
                                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm text-sm"
                                        placeholder="Keterangan tambahan mengenai ruangan..."
                                    ></textarea>
                        ...
                        <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3 border-t border-gray-200">
                            ...
                            <button 
                                ...
                                class="px-6 py-2 bg-gray-900 text-white rounded-lg text-sm font-bold hover:bg-gray-800 transition shadow-md flex items-center gap-2 disabled:opacity-50"
                            >
